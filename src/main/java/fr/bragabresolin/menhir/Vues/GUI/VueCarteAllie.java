...
public class VueCarteAllie extends JPanel implements Observer, BlackTheme {
	...
	/**
	 * Constructeur.
	 * On construit la vue de la carte en affichant sa matrice des forces et son
	 * nom, ainsi qu'en y attachant des écouteurs d'événement clic. Un clic sur 
	 * la carte signifie que le joueur veut jouer cette carte, auquel cas, si la
	 * carte est jouable (par exemple si c'est au tour du joueur), les 
	 * informations nécessaires à son exécution sont demandées, et elle est 
	 * déposée dans le tampon de communication adapté.
	 *
